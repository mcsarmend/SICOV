...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="card">
                <div class="card-body">
                    <form method="post" id="enviarentrada">
                        <div class="row">
...
@section('js')
    ...
    <script>
        ...
        $('#enviarentrada').submit(function(e) {
            ...
            Swal.fire({
                title: '¡Se realizará un ingreso de mercancia por "Entrada"!',
                ...
                if (result.isConfirmed) {
                    ...
                    numeroRemision = enviarentrada("ENTRANCEMERCH", datos, documento, sum, sucursal);

                }
            });
        });

        function enviarentrada(movimiento, data, documento, suma, sucursal) {
            ...
            $.ajax({
                url: 'enviarentrada', // URL a la que se hace la solicitud
